export default function Home() {
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/food"
                className="bg-white text-green-700 px-8 py-4 rounded-lg shadow-lg hover:bg-green-50 font-semibold text-lg transition-all duration-300 transform hover:scale-105"
              >
                🍽️ Browse Donations
              </a>
              <a 
                href="/register"
                className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white hover:text-green-700 font-semibold text-lg transition-all duration-300"
              >
                🤝 Join Our Mission
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              We are the effective link between food donors and deserving recipients. We are actively contributing to the attainment of <span className="font-semibold text-green-700">SDG 12</span> by reducing food waste and promoting responsible consumption.
            </p>
            <p className="text-xl text-gray-700 leading-relaxed">
              The spirit of <span className="font-semibold text-green-700">Ubuntu</span> powers us to support the vulnerable by ensuring that surplus food reaches those in need.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="bg-green-600 text-white px-8 py-4 rounded-lg hover:bg-green-700 font-semibold text-lg transition-colors duration-300"
            >
              Become a Donor
            </a>
            <a 
      ...
      {/* Stats Section (Optional - can be dynamic later) */}
